...
/// Returns null when no user is logged in, which guards all grievance
/// queries so they never fire with a hardcoded / wrong ID.
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: _buildBannerItem(banners[index], theme),
                        );
                      },
                    ),
                  ),
