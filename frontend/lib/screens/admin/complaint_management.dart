...
bool _isTerminal(String status) => status == 'closed' || status == 'rejected';
...
boxShadow: [BoxShadow(color: glow.withValues(alpha: 0.07), blurRadius: 16)],
);
...
class _ComplaintManagementState extends ConsumerState<ComplaintManagement>
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      setState(() {
        _grievances = gs;
        _assignees = us
            .where((u) => u.role?.toLowerCase() == 'field_staff')
            .toList();
      ...
      list = list
          .where(
            (g) =>
                ...
                (g.citizen?.name?.toLowerCase().contains(q) ?? false),
          )
          .toList();
    }
    return list;
  ...
  PreferredSizeWidget _buildAppBar() => AppBar(
    ...
    bottom: PreferredSize(
      ...
      child: Container(height: 1, color: _cyan.withValues(alpha: 0.3)),
    ),
    title: Row(
      children: [
        AnimatedBuilder(
          ...
          builder: (_, __) => Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: _orange.withValues(alpha:0.3 + _pulseCtrl.value * 0.7),
                  blurRadius: 10,
                ),
              ],
            ),
    ...
    return TweenAnimationBuilder<double>(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: sc.withValues(alpha:terminal ? 0.1 : 0.3),
            width: terminal ? 1 : 1.5,
          ),
          boxShadow: terminal
              ? []
              : [BoxShadow(color: sc.withValues(alpha:0.1), blurRadius: 16)],
        ),
        child: Column(
          children: [
            // ── Header stripe ──────────────────────────────────────────
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(bottom: BorderSide(color: sc.withValues(alpha:0.15))),
              ),
              child: Row(
                children: [
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      if (g.citizen != null)
                        _metaChip(Icons.person, g.citizen!.name ?? '', _text2),
                      _metaChip(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: _mono(10, c: sc.withValues(alpha:0.8)),
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _transitionBtn(Grievance g, String next) {
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
        decoration: BoxDecoration(
          color: nc.withValues(alpha:0.15),
          borderRadius: BorderRadius.circular(8),
          border: Border.all(color: nc.withValues(alpha:0.5)),
          boxShadow: [BoxShadow(color: nc.withValues(alpha:0.2), blurRadius: 8)],
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
  ...
  Future<void> _confirmTransition(Grievance g, String next) async {
      ...
      builder: (ctx) {
        ...
        return Dialog(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: BorderSide(color: nc.withValues(alpha:0.4)),
          ),
          child: Padding(
                    ...
                    Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: _mono(11, c: _red.withValues(alpha:0.5)),
                          border: InputBorder.none,
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: nc.withValues(alpha:0.2),
                            foregroundColor: nc,
                            side: BorderSide(color: nc.withValues(alpha:0.5)),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(8),
                            ),
                          ),
    ...
    try {
      ...
      await ref
          .read(adminProvider.notifier)
          .updateGrievanceStatusWithBody(g.id, next, body);
                        ...
                        onPressed: selected == null
                            ...
                            : () async {
                                ...
                                try {
                                  ...
                                  _showToast('Assign failed: $e', _red);
                                }
                              },
                        style: ElevatedButton.styleFrom(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        try {
                          await ref
                              .read(adminProvider.notifier)
                              .addComment(g.id, ctrl.text.trim());
                          _showToast('Comment added', _purple);
                        } catch (e) {
                          _showToast('Failed: $e', _red);
                        }
                      },
                      style: ElevatedButton.styleFrom(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: _mono(11, c: _red.withValues(alpha:0.85)),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _emptyState() => Center(
    child: Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Icon(Icons.inbox, color: _text2.withValues(alpha:0.4), size: 64),
        const SizedBox(height: 12),
